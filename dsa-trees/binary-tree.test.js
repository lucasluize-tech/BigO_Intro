...
describe("maxSum", function () {
  ...
  it("handles more complex trees", function () {
    // original was maxSum to be 21, which is wrong in 6+5+5+3+2+1+1;
    expect(largeTree.maxSum()).toBe(23);
  });
  ...
  it("handles negative values", function () {
    ...
    // original was maxSum to be 109, which is wrong in 100+8-4+2-3+10;
    expect(tree.maxSum()).toBe(113);
  });
});
